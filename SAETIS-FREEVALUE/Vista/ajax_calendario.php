	...
	case "listar_evento":
	{
		...
		if ($fila=$query->fetch_array())
		{
			do
			{
				...
				echo "<p>".$fila["evento"]."<a href='#' class='editar_evento' rel='".$fila["id"]."' title='editar este Evento del ".fecha($_GET["fecha"])."'><img src='images/edit.png'></a></p>";
			}
...
/*<abbr title='S&oacute;lo se pueden agregar eventos en d&iacute;as h&aacute;biles y en fechas futuras (o la fecha actual).'>(?)</abbr>*/
		;
